...
-- 加入各項實用功能按鈕
createButton("⚔️ 自動農怪與等級 (Auto Farm Level)", 70, function()
    print("[KL Script] 自動農怪功能已啟動...")
    -- 這裡可對接你的自動刷等邏輯
end)

createButton("🏝️ 島嶼瞬間傳送 (Island Teleport)", 120, function()
    print("[KL Script] 開啟島嶼傳送選單...")
end)

createButton("⚡ 玩家強化 / 無限體力 (Player Stats & Misc)", 170, function()
    print("[KL Script] 玩家強化功能已套用...")
end)

createButton("🔄 尋找低人數伺服器 (Server Hop)", 220, function()
...
closeBtn.Position = UDim2.new(0.5, -60, 0.85, 0)
